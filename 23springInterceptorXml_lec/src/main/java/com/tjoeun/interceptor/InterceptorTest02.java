...
public class InterceptorTest02 implements HandlerInterceptor{
	...
	*/
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		System.out.println("InterceptorTest02 - preHandle() 메소드");
		return true;
	}
	/*
	...
	*/
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
		...
		System.out.println("InterceptorTest02 - postHandle() 메소드");
	}
	...
	*/
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex)
			throws Exception {
		System.out.println("InterceptorTest02 - afterCompletion() 메소드");
	}
